...
\input{Chapters/CommonClassifiers} % Background Theory 

\input{Chapters/QualityEvaluation} % Experimental Setup

\input{Chapters/Datasets} % Dataset description

\input{Chapters/ClassifierTrees} % Experimental Setup
