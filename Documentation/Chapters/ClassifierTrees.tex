...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.7\textwidth]{Figures/slanting_tree_structure_part.jpg}
...
\begin{table}[htp]
	\centering
	\caption{Measures values for classifier trees using various common classifiers on training data}
...
\begin{table}[htp]
	\centering
	\caption{Measures values for classifier trees using various common classifiers on test data}
