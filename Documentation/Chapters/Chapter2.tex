...
\begin{figure}[htp]
	...
	\caption{Visualization of area coverage of three different class membership for kNN classifier with k=15, using euclidean metric}
...
\begin{figure}[htp]
	...
	\caption{SVM hyperplane construction with the biggest possible margin for training dataset}
...
\begin{figure}[htp]
	...
	\caption{Different class area coverages resulting from usage of different kernel functions}
